...
router.post('/generate-suggestions', authMiddleware, asyncHandler(async (req, res) => {
...
router.post('/analyze-quality', authMiddleware, asyncHandler(async (req, res) => {
...
router.post('/apply-suggestion', authMiddleware, asyncHandler(async (req, res) => {
...
router.get('/enhancement-status/:planId', authMiddleware, asyncHandler(async (req, res) => {
...
router.post('/compare-layouts', authMiddleware, asyncHandler(async (req, res) => {
...
router.get('/design-trends', authMiddleware, asyncHandler(async (req, res) => {
  const trends = {
    popularStyles: [
      'Modern Minimalist',
      'Contemporary',
...
router.post('/generate-floorplan', authMiddleware, asyncHandler(async (req, res) => {
  const {
    plotWidth,
    plotDepth,
    rooms,
  ...
  try {
    ...
    return res.status(502).json({
      success: false,
      message: 'AI model service is unavailable. Please try again shortly.'
    });
  }
...
router.post('/compare-models', authMiddleware, asyncHandler(async (req, res) => {
...
router.post('/analyze-vastu', authMiddleware, asyncHandler(async (req, res) => {
...
router.get('/available-models', authMiddleware, asyncHandler(async (req, res) => {
  const models = [
    {
      id: 'housediffusion',
      name: 'HouseDiffusion',
...
router.post('/save-generated-plan', authMiddleware, asyncHandler(async (req, res) => {
  const {
    title,
    description,
    floorplan,
